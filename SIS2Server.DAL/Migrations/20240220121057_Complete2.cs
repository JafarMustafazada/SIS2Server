    ...
    public partial class Complete2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilyReletaions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceOfLiving = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CurrentSemester = table.Column<int>(type: "int", maxLength: 9, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Semester = table.Column<int>(type: "int", maxLength: 9, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserTeachers_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Entered = table.Column<DateOnly>(type: "date", nullable: false),
                    Graduation = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FamilyReletaionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FamilyMembers_FamilyReletaions_FamilyReletaionId",
                        column: x => x.FamilyReletaionId,
                        principalTable: "FamilyReletaions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentFormerGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentFormerGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserStudents_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyMembers_FamilyReletaionId",
                table: "FamilyMembers",
                column: "FamilyReletaionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentFormerGroups_GroupId",
                table: "StudentFormerGroups",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentFormerGroups_StudentId",
                table: "StudentFormerGroups",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserStudents_AppUserId",
                table: "UserStudents",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTeachers_AppUserId",
                table: "UserTeachers",
                column: "AppUserId");
